...
def get_command(message):
    ...
    if message.text == "/start":
        ...
        for elem in manga:
            ...
            if elem == "volumes":
                manga_description += (
                    "The amount of volumes: " + str(manga[elem]) + ". \n"
                )
            if elem == "chapters":
                manga_description += (
                    "The amount of chapters: " + str(manga[elem]) + ". \n"
                )
            if elem == "score":
        ...
        for elem in character:
            ...
            if elem == "name_kanji":
                character_description += (
                    "Name written in kanji: " + str(character[elem]) + ".\n"
                )
            if elem == "about":
                character_description += (
                    "Information about the character: " + str(character[elem]) + ".\n"
                )
        character_description += (
            "\nRead more on "
        ...
        schedule_text = (
            "Please, write the day of the week "
        ...
        for i in range(len(schedule["tuesday"])):
            schedule_tuesday += (
                str(i + 1) + ". " + schedule["tuesday"][i]["title"] + "\n"
            )
        ...
        for i in range(len(schedule["wednesday"])):
            schedule_wednesday += (
                str(i + 1) + ". " + schedule["wednesday"][i]["title"] + "\n"
            )
        ...
        for i in range(len(schedule["thursday"])):
            schedule_thursday += (
                str(i + 1) + ". " + schedule["thursday"][i]["title"] + "\n"
            )
        ...
        for i in range(len(schedule["saturday"])):
            schedule_saturday += (
                str(i + 1) + ". " + schedule["saturday"][i]["title"] + "\n"
            )
        ...
        anime_bot.send_message(
            message.from_user.id,
            "Sorry, I don't understand you. " "Please, write /help.",
        )
